<template>
    <nav v-if="totalPages > 1" class="flex items-center justify-center gap-3 pt-8">
        <button id="prev-page" :disabled="page <= 1"
            class="flex items-center gap-2 bg-transparent border border-light-gray-border rounded-circular px-5 py-2.5 text-body-sm text-ash-gray hover:text-midnight-pine hover:border-steel-border transition-colors disabled:opacity-30 disabled:cursor-not-allowed font-inter"
